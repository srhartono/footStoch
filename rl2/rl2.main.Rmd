...
#dG = a + sum(B) + B.sigma(n,m,)

B.sigma = B.sigma.precalc(n=par$n,m=par$len,sigma=-0.07,par=par)
...
for (i in 1:length(myseqs)) {
  ...
  mygrid = data.frame(n=1,m=seq(0,nchar(seq1)))
  mygrid$sumB = apply(mygrid,1,dgb,dgseq=dgseq1$RD.min.DD)
